(define (problem pb15) (:domain rover)
(:objects
	general colour high_res low_res rover0 rover1 rover2 rover3 rover4 rover0store rover1store rover2store rover3store rover4store waypoint0 waypoint1 waypoint2 waypoint3 waypoint4 waypoint5 waypoint6 waypoint7 waypoint8 waypoint9 waypoint10 camera0 camera1 camera2 camera3 objective0 objective1 objective2 objective3 objective4 )
(:init
